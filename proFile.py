...
# Create and place widgets with professional design
header_frame = tk.Frame(root, bg="#2D2D2D", pady=10)
header_frame.pack(fill='x')

tk.Label(header_frame, text="Password Generator", font=("Arial", 20, "bold"), bg="#2D2D2D", fg="#FFFFFF").pack()

main_frame = tk.Frame(root, bg="#1E1E1E", pady=20)
main_frame.pack(pady=20)

tk.Label(main_frame, text="Enter the number of characters:", font=("Arial", 12), bg="#1E1E1E", fg="#CCCCCC").pack(pady=5)

entry = tk.Entry(main_frame, font=("Arial", 14), width=15, justify='center')
entry.pack(pady=5)

generate_button = tk.Button(main_frame, text="Generate Password", font=("Arial", 14), bg="#4CAF50", fg="#FFFFFF", activebackground="#45a049", relief='flat', command=generate_password)
generate_button.pack(pady=20, fill='x')

result_var = tk.StringVar()
result_label = tk.Label(main_frame, textvariable=result_var, font=("Arial", 14), bg="#1E1E1E", fg="#E0E0E0", wraplength=400)
result_label.pack(pady=10)

# Terms and Conditions
terms_frame = tk.Frame(root, bg="#1E1E1E")
terms_frame.pack(fill='both', pady=10, padx=20)

terms_label = tk.Label(terms_frame, text="Terms and Conditions:", font=("Arial", 14, "bold"), bg="#1E1E1E", fg="#FFFFFF")
...
terms_text_widget = tk.Text(terms_frame, wrap='word', height=10, width=50, font=("Arial", 12), bg="#2D2D2D", fg="#E0E0E0", padx=10, pady=10)
